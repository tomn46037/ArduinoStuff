...
void setup() 
{
  ...
  lcd0.backlight();
  lcd0.setCursor(0,0);
  lcd0.print("UDP NTP Client:");
  lcd0.setCursor(0,1);
  lcd0.print("Await Serial");
...
void loop()
{
  ...
  if ( !(secsSince1900 % 600) || secsSince1900 == 0 ) {
    ...
    lcd0.setCursor(0,0);
    lcd0.print("Sending request.");

    sendNTPpacket(timeServer); // send an NTP packet to a time server

    lcd0.setCursor(0,0);
    lcd0.print("Await response..");
